    ...
    return (
        <Box sx={{height:"165px", overflow: 'hidden',}}>
            <Typography variant={size} sx={{
                animation: startAnimation ? `move-up ${time}s cubic-bezier(0.455, 0.030, 0.515, 0.955) both, lose-width-complete 1s cubic-bezier(0.455, 0.030, 0.515, 0.955) 0.5s both` : "none",
            }}>
                {letter}
            </Typography>
